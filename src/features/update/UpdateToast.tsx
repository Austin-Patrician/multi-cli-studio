...
export function UpdateToast({ state, onUpdate, onDismiss }: UpdateToastProps) {
  ...
  return (
    <div className="app-update-toast" role="status">
      ...
      {state.stage === "checking" ? <div className="app-update-toast-body">正在检查更新…</div> : null}
      ...
      {state.stage === "installing" ? <div className="app-update-toast-body">正在安装更新…</div> : null}

      {state.stage === "restarting" ? <div className="app-update-toast-body">安装完成，正在重启应用…</div> : null}
