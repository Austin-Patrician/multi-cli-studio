...
export function AssistantMessageContent({
  ...
  isStreaming,
  renderMode,
  codeBlockRadiusClass = "rounded-[20px]",
  ...
  const markdownComponents = createMarkdownComponents(codeBlockRadiusClass);
  ...
  if (format === "log") {
    return (
      <div className={`overflow-hidden border border-[#172033] bg-[#0f172a] ${codeBlockRadiusClass}`}>
