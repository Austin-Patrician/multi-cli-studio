      ...
      <div className="mx-auto flex max-w-[1540px] flex-col gap-6 px-8 py-8">
        <section className="flex flex-wrap items-center gap-4 rounded-[30px] border border-[#eceae4] bg-white/92 px-4 py-4 shadow-[0_10px_26px_rgba(15,23,42,0.05)] backdrop-blur">
          <div className="flex min-w-0 flex-1 justify-center">
            <div className="flex min-w-0 flex-wrap items-center gap-2 rounded-full bg-[#f5f4f1] p-1.5">
              {MODEL_PROVIDER_SERVICE_ORDER.map((serviceType) => {
                ...
                return (
                  <button
                    ...
                    className={cx(
                      "inline-flex min-w-[144px] items-center justify-center gap-2 rounded-full border px-5 py-2.5 text-[15px] font-medium transition-all",
        ...
        <section className="rounded-[32px] border border-[#eceae4] bg-white/92 p-6 shadow-[0_14px_32px_rgba(15,23,42,0.04)]">
          <div className="space-y-4">
            {providers.length === 0 ? (
              <div className="rounded-[28px] border border-dashed border-slate-200 bg-[#fbfaf8] px-5 py-10 text-center">
