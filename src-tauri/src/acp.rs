...
pub fn command_registry() -> Vec<AcpCommandDef> {
    vec![
        ...
        AcpCommandDef {
            ...
            slash: "/goal".into(),
            label: "Goal".into(),
            description: "Set or view the current Codex goal workflow".into(),
            args_hint: Some("[objective|pause|resume|clear]".into()),
            execution: "native-chat".into(),
        ...
        AcpCommandDef {
            ...
            description: "Set Codex speed mode".into(),
